...
window.setInterval(doInverseSpinZeroPitch,150);});$(function(){$(".typed").typed({strings:['Разработчик',"Программист",".Net в моём сердце","За c# и двор"],typeSpeed:100,loop:true,cursorChar:"|",});});
